...
plt.plot(rr2, er2p, 'x--', label='EPABF-II', color='red',linewidth = 1,markersize = 9, markevery = 100)
...
plt.title('USPS: Error Rate v/s Rounds',fontsize = "xx-large")
